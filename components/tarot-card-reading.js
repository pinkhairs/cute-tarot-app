class TarotCardReading extends HTMLElement {
  ...
  render() {
    ...
    <div class="flex flex-col w-full">
      <div class="w-full card-container h-64 md:h-80 short:h-56 lg:h-64">
        <div id="card" class="card transition-all duration-1000 h-64 md:h-80 short:h-56 lg:h-64">
            <div class="card-face card-front">
              <img src="${this.card}" id="card-back" class="rounded-3xl bg-[rgba(255,255,255,.85)] shadow-[0_0_56px_-8px_rgba(85,123,193,0.2)] h-64 md:h-80 short:h-56 lg:h-64" alt="">
            </div>
            <div class="card-face card-back">
              <img src="${this.card}" id="card-image" class="rounded-3xl bg-[rgba(255,255,255,.85)] shadow-[0_0_56px_-8px_rgba(85,123,193,0.2)] h-64 md:h-80 short:h-56 lg:h-64" alt="">
            </div>
        </div>
      </div>
      <div class="flex mt-8 flex-col">
        ...
        <div id="card-info" class="flex items-center justify-center gap-4 flex-col">
          ...
          <div id="set-intention-button" class="duration-1000 opacity-0 transition-opacity text-center items-center justify-center">
            <a href="/app/tarot/set-intention.html" class="w-max mx-auto transition-opacity origin-top duration-1000 bg-brand text-xl font-serif text-white rounded-xl px-4 py-3">Set Intention</a>
          </div>
        </div>
      </div>
    </div>
