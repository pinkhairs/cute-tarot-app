...
<div class="flex flex-col px-6 gap-4 md:gap-6 w-full">
  <div class="w-full relative card-container h-64 md:h-80 short:h-56 lg:h-64 xl:h-80">
    <div id="card" class="absolute card transition-all duration-1000 h-64 md:h-80 short:h-56 lg:h-64 xl:h-80">
  ...
  <div class="flex flex-col">
    <button on:click={flipCard} id="flip-card-button" type="button" class="w-max mx-auto transition-opacity origin-top duration-1000 bg-brand text-xl font-serif text-white rounded-xl px-6 py-3">Get Reading</button>
    <div id="card-info" class="flex -z-20 items-center justify-center gap-4 flex-col">
      ...
      {#if intention}
        <div on:click={() => manifested ? null : goToEntry} class="field flex flex-col items-center justify-between p-3.5 text-black bg-translucent gap-3 w-full rounded-2xl">
      ...
      {:else}
        <div id="set-intention" class="duration-1000 opacity-0 transition-opacity text-center items-center justify-center">
          <button on:click={goToEntry} id="set-intention-button" type="button" class="w-max mx-auto transition-opacity origin-top duration-1000 bg-brand text-xl font-serif text-white rounded-xl px-6 py-3">Set Intention</button>
        </div>
      {/if}
    </div>
  </div>
