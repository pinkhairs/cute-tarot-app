...
{:else}
  ...
  {#if $user}
    <div class="py-4 px-5 rounded-xl bg-[#9972d9] bg-opacity-75 flex items-center gap-6">
      <div class="flex items-center justify-between w-full">
        <div class="items-center flex gap-4">
          <img src={pentacles} class="w-16" alt="Settings">
          <div class="flex flex-col items-start">
            <h1 class="font-serif text-white text-2xl">{pentaclesBalance}</h1>
            <p class="opacity-80 text-white">pentacles</p>
          </div>
        </div>
        <button type="button" on:click={goToPentacles} class="text-black bg-opacity-80 bg-white px-4 py-2 rounded-md font-serif">Get More</button>
      </div>
    </div>
      {/if}
      <h2 class="text-center font-serif text-2xl pt-4 pb-2">Badges</h2>
      {#if !$user}
      <button
    ...
    <div class="grid grid-cols-2 gap-[2px] rounded-xl overflow-hidden">
      ...
      <div class="flex px-2.5 py-3 flex-col items-center bg-translucent gap-2">
        <h1 class="font-['Madimi_One'] text-[#FFEECC] bg-opacity-60 w-[3.5rem] h-[3.5rem] flex items-center justify-center rounded-2xl bg-black"><span class="inline-block relative left-[1px]">?</span></h1>
      ...
      <div class="flex px-2.5 py-3 flex-col items-center bg-translucent gap-2">
        <h1 class="font-['Madimi_One'] text-[#C0EFFF] bg-opacity-60 w-[3.5rem] h-[3.5rem] flex items-center justify-center rounded-2xl bg-black"><span class="inline-block relative left-[1px]">?</span></h1>
        <h3 class="w-full text-center">Full Moon</h3>
        <p class="text-sm opacity-80 w-full text-center">Reading relevant to full moon</p>
      </div>
      <div class="flex px-2.5 py-3 flex-col items-center bg-translucent gap-2">
        <h1 class="font-['Madimi_One'] text-[#E9E0FF] bg-opacity-60 w-[3.5rem] h-[3.5rem] flex items-center justify-center rounded-2xl bg-black"><span class="inline-block relative left-[1px]">?</span></h1>
        <h3 class="w-full text-center">New Moon</h3>
        <p class="text-sm opacity-80 w-full text-center">A new moon reading</p>
      </div>
      <div class="flex px-2.5 py-3 flex-col items-center bg-translucent gap-2">
        <h1 class="font-['Madimi_One'] text-neutral bg-opacity-60 w-[3.5rem] h-[3.5rem] flex items-center justify-center rounded-2xl bg-black"><span class="inline-block relative left-[1px]">?</span></h1>
