class NewVisionBoard extends HTMLElement {
  ...
  render() {
    ...
    <form method="post" enctype="multipart/form-data" action="/pwa.php?action=upload_inspiration" id="new" class="w-full  mx-auto flex-col px-4 flex-1 flex items-center justify-start gap-6">
